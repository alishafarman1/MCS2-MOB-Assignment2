    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usersList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                i.putExtra("image",userMap.get("image"));
                startActivity(i);
            }
        });
        loadData();
    ...
    void loadData(){
        childEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                userMap.put("image",dataSnapshot.child("image").getValue().toString());
                dataMap.add(userMap);
        ...
        FirebaseDatabase.getInstance().getReference("users").addChildEventListener(childEventListener);
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        FirebaseDatabase.getInstance().getReference("users").removeEventListener(childEventListener);
    }
}
